...
This is **not** the standard OpenLP release.
...
* Service item generation with EGW-aware references and optional footer output.
* Configurable EGW display theme and footer reference visibility.
